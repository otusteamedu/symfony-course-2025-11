 ...
 */
final class Version20251218224600 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "email_user" ADD CONSTRAINT FK_12A5F6CCBF396750 FOREIGN KEY (id) REFERENCES "user" (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE phone_user ADD CONSTRAINT FK_6E97845BBF396750 FOREIGN KEY (id) REFERENCES "user" (id) ON DELETE CASCADE');
