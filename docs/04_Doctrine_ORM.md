...
1. Заходим в контейнер `php` командой `docker exec -it php-fpm sh`. Дальнейшие команды выполняются из контейнера
...
10. Заходим в контейнер `php` командой `docker exec -it php-fpm sh`, дальнейшие команды выполняются из контейнера
